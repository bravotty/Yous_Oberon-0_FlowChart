    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		String p_d = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
				...
				/* 
				��Ϊ������ģ���еĶ�����������״̬ջint_stack���Ƿ���ֵΪ��־���鿴��ǰ������ͼ���ƶ���ķ�Χ��
				״̬ջ�в�Ϊ�գ����ʾ��ǰ����ͼ���Ʒ�Χ�ں����У�Ŀǰ��declaration������ӵ�����ͼ�У����Ϊ�գ����־
				��ǰ������Ʒ�ΧΪģ��module��
				*/
				if(!int_stack.empty())
				{
		...
		String identifier = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
				...
				/*
				������������״̬ջint_stack�е���ջ������ʾһ���������ƽ�����
				��˵�һ������������ͼ���ƽ���ʱ��int_stackջΪ�ա�
				*/
				int_stack.pop();
				// ����β�����������Ա��麯�����Ƿ�ƥ��
				RESULT = identifier;
		...
		String a = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
				...
				/* 
				�ж�int_stack�Ƿ�Ϊ�գ���Ϊ���жϺ�������λ������procedure��Χ�ڣ�������module��Χ�ڣ�
				int_stackΪ��������module��Χ�ڣ�int_stack��Ϊ��������precedure��Χ�ڡ�
				*/
				if(!int_stack.empty())
				{	
					// �жϵ�ǰ�Ļ�������ͼ��״̬��Ȼ����ǰ��������ͼ�Ķ�����������
		...
		String e = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
				...
				*/
				...
				// ��ջ��pushһ������1����ʾ���ڵ�����ͼ���ƶ���ת��Ϊwhile����ͼ���ƶ���
		...
		String e = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
				...
				// ��״̬ջint_stack�����һ��3����ʾ���ڵ�����ͼ����״̬Ӧ����ӵ�if����false��֧
